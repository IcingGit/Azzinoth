...
| 类别 | 采集项 | 说明 |
|------|--------|------|
| 硬件信息 | CPU型号、核心数、主频、缓存 | 定时采集 |
| 硬件信息 | 内存型号、容量、频率、类型、插槽数 | 定时采集 |
| 硬件信息 | 磁盘型号、容量、类型(SSD/HDD)、接口、序列号 | 定时采集 |
| 硬件信息 | 主板型号、厂商、序列号 | 定时采集 |
| 硬件信息 | 网卡型号、MAC地址、速率 | 定时采集 |
| 硬件信息 | USB设备列表(名称、VID/PID、连接状态) | 定时采集 |
| 系统信息 | OS版本、Build号、激活状态 | 定时采集 |
| 系统信息 | 主机名、域名、工作组 | 定时采集 |
