...
| 类别 | 采集项 | 说明 |
|------|--------|------|
| 硬件信息 | CPU型号、核心数、主频、缓存 | 系统启动时采集 |
| 硬件信息 | 内存型号、容量、频率、类型、插槽数 | 系统启动时采集 |
| 硬件信息 | 磁盘型号、容量、类型(SSD/HDD)、接口、序列号 | 系统启动时采集 |
| 硬件信息 | 主板型号、厂商、序列号 | 系统启动时采集 |
| 硬件信息 | 网卡型号、MAC地址、速率 | 系统启动时采集 |
| 硬件信息 | USB设备列表(名称、VID/PID、连接状态) | 系统启动时采集，定时更新 |
| 系统信息 | OS版本、Build号、激活状态 | 系统启动时采集 |
| 系统信息 | 主机名、域名、工作组 | 系统启动时采集 |
| 运行状态 | CPU使用率、温度(如有) | 定时采集 |
| 运行状态 | 内存使用率、可用量 | 定时采集 |
| 运行状态 | 磁盘使用率、各分区空间 | 定时采集 |
| 运行状态 | 网络连接状态、流量统计 | 定时采集 |
